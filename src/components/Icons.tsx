/** Simple SVG icons for services - no emojis, accessible */

export function IconCar({ className = 'w-10 h-10' }: { className?: string }) {
  return (
...
export function IconMoto({ className = 'w-10 h-10' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      <path d="M6 17h12" />
      <path d="M12 5v6l4 6" />
      <path d="M12 5L9 11h6l-3-6z" />
    </svg>
  );
}

export function IconTool({ className = 'w-10 h-10' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
export function IconCash({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
